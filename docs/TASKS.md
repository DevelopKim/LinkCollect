...
### Popup HTML
- [ ] Popup HTML 구조 작성 (src/popup/popup.html)
- [ ] 도메인 필터 입력 필드
- [ ] 작업 모드 선택 (라디오 버튼 또는 토글)
- [ ] 추출 버튼
- [ ] 결과 표시 영역 (간략 정보, 상세 정보)
- [ ] 다운로드 버튼
- [ ] 로딩 상태 표시 영역

### Popup 스타일
- [ ] 기본 CSS 스타일 작성 (src/popup/popup.css)
- [ ] 반응형 레이아웃
- [ ] 링크 목록 스타일링
- [ ] 버튼 스타일링
- [ ] 로딩 애니메이션
...
### Popup 로직
- [ ] Popup 초기화 로직 (src/popup/popup.ts)
- [ ] 설정 로드 및 UI에 반영
- [ ] 도메인 필터 입력 처리
- [ ] 작업 모드 선택 처리
- [ ] 추출 버튼 클릭 핸들러
